        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="img-fluid" src="img/project/h1.jpg" alt="Image">
                    <div class="carousel-caption d-flex align-items-center justify-content-center">
                        <div class="p-5" style="width: 100%; max-width: 900px;">
                            <h5 class="text-primary text-uppercase mb-md-3">Cleaning and Transportation Services</h5>
                            <h1 class="display-3 text-white mb-md-4">Full satisfaction service</h1>
                            <a href="" class="btn btn-primary">Login/Register</a>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    <img class="img-fluid" src="img/project/h2.jpg" alt="Image">
                    <div class="carousel-caption d-flex align-items-center justify-content-center">
                        <div class="p-5" style="width: 100%; max-width: 900px;">
                            <h5 class="text-primary text-uppercase mb-md-3">Cleaning and Transportation Services</h5>
                ...
                <div class="carousel-item">
                    <img class="img-fluid" src="img/project/h3.jpg" alt="Image">
                    <div class="carousel-caption d-flex align-items-center justify-content-center">
                        <div class="p-5" style="width: 100%; max-width: 900px;">
                            <h5 class="text-primary text-uppercase mb-md-3">Cleaning and Transportation Services</h5>
                            <h1 class="display-3 text-white mb-md-4">Call us now!</h1>
                            <a href="" class="btn btn-primary">Get A Quote</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 pt-5 pt-lg-0">
                    <div class="owl-carousel service-carousel position-relative">
                        <div class="d-flex flex-column align-items-center text-center bg-white rounded overflow-hidden pt-4">
                            ...
                            <h5 class="font-weight-bold mb-4 px-4">Cleaning Service</h5>
                        ...
                        <div class="d-flex flex-column align-items-center text-center bg-white rounded overflow-hidden pt-4">
                            ...
                            <h5 class="font-weight-bold mb-4 px-4">Transportation Service</h5>
